...
import * as $Api from "@/api/member/level";
...
const pageData: any = reactive({
  ...
  tableParams: {
    columns: [
      ...
      { label: "老vip", prop: "oldVip",slot:"levelOldSlot"},
      { label: "新vip", prop: "newVip",slot:"levelNewSlot"},
